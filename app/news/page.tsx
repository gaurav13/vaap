...
export const metadata = {
  title: "News | VAAP",
  description: "The latest news and announcements from the Virtual Assets Association of Pakistan.",
}

export default async function NewsPage() {
  const [posts, user] = await Promise.all([getPublishedNews(), getHeaderUser()])
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="Updates on policy, partnerships, and community initiatives across Pakistan's virtual asset ecosystem."
        />
              ...
              {posts.map((p) => (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <h3 className="mt-3 font-bold leading-snug text-heading">{p.title}</h3>
